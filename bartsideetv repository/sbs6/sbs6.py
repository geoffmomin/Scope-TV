...
class Module(BARTSIDEE_MODULE):
    def __init__(self, app):
        ...
        self.name               = "Sbs6 Gemist"                     #Name of the channel
        ...
        self.url_base           = 'http://www.sbs6.nl'
        self.url_home           = '%s/web/show/id=73863/langid=43' % self.url_base
        self.exclude            = ['Hart van Nederland', 'Piets Weerbericht']
    ...
    def Episode(self, stream_name, stream_id, page, totalpage):
        ...
        data = tools.urlopen(self.app, url, {'cach':3600})
